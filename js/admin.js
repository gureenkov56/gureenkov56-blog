document.addEventListener("DOMContentLoaded", () => {
  ...
  directionItem.forEach((folder) => {
    folder.addEventListener("click", () => {
      ...
      if (ID === "Posts") {
        let windowsFolderBodyRightWrapper = newWindow.querySelector(
          ".windows__folder__body__right__wrapper"
        );
        let contentItemTemplate = newWindow.querySelector(
        ...
        fetch(
          ...
          .then((data) => {
            data.forEach((contentItem) => {
              ...
              newContentDOM.querySelector(".fileinfo__title").innerHTML = contentItem.h1.slice(0, 17) + '...';
